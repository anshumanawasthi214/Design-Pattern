...
//		}
	...
	private static SingletonDesignPattern  eagerObject; //static variables don't need to initialize with any value default is null
	
			private SingletonDesignPattern() {}//making constructor private so it can't be accessible;
			
			public static SingletonDesignPattern getObject(){//Using Getter to create object
				if(eagerObject==null) {
					eagerObject=new  SingletonDesignPattern();
				}
					return eagerObject;
